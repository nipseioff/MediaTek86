...
namespace MediaTek86
    ...
    partial class FormPersonnel 
        ...
        // Ouvre une nouvelle instance du formulaire Personnel
        ...
        // Charge toutes les données de la table personnel dans le DataGridView
        ...
        private void btn_save_Click(object sender, EventArgs e)
            ...
            foreach (DataRow row in changes.Rows)
                {
                // Insertion d'un nouveau membre dans la table personnel
                    ...
                    Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                ...
                // Mise à jour d'un membre existant dans la table personnel
                    ...
                    Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                ...
                // Suppression d'un membre dans la table personnel
        ...
        private void InitializeComponent()
            ...
            // 
            this.dataGriedViewPersonnel.BackgroundColor = System.Drawing.Color.FromArgb(45, 45, 70);
            this.dataGriedViewPersonnel.GridColor = System.Drawing.Color.FromArgb(80, 80, 120);
            this.dataGriedViewPersonnel.DefaultCellStyle.BackColor = System.Drawing.Color.FromArgb(45, 45, 70);
            this.dataGriedViewPersonnel.DefaultCellStyle.ForeColor = System.Drawing.Color.White;
            this.dataGriedViewPersonnel.ColumnHeadersDefaultCellStyle.BackColor = System.Drawing.Color.FromArgb(52, 120, 200);
            this.dataGriedViewPersonnel.ColumnHeadersDefaultCellStyle.ForeColor = System.Drawing.Color.White;
            this.dataGriedViewPersonnel.EnableHeadersVisualStyles = false;
